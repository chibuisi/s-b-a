package com.kelvin.spring.batch.runner;

import com.kelvin.spring.batch.utils.Constants;
...
public class JobRunner {
    ...
    public void runBatchJob() {
        ...
        jobParametersBuilder.addString(Constants.FILE_NAME_CONTEXT_KEY, "students.csv");
